...
export class ConfigurationLoader {
  ...
  public getFanoutCoefficients() {
    return {
      xap_lss: this.config.fanoutMetrics.xapLssFanout.typical / 10000, // Normalized
      lss_cso: this.config.fanoutMetrics.lssCsoFanout.typical / 10000, // Normalized  
      cso_store: this.config.fanoutMetrics.csoStoreFanout.typical / 10000 // Normalized
    };
  }
